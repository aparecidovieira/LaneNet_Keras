...
def build_lanenet3(input_shape,input_shape1=[128, 128, 3], one_hot_label=False):
    ...
    res_1_1 = C.encoder_block(inputs1, n_filters)
    skip_1_1 = C.pool(res_1_1)
    skip_1_1 = C.concat(skip_1_1, inputs_waves1)

    res_2_1 = C.encoder_block(inputs2, n_filters)
    skip_2_1 = C.pool(res_2_1)


    res_1_2 = C.encoder_block(skip_1_1, 2 * n_filters)
    skip_1_2 = C.pool(res_1_2)
    skip_1_2 = C.concat(skip_1_2, inputs_waves2)


    res_2_2 = C.encoder_block(skip_2_1, 2 * n_filters)
    skip_2_2 = C.pool(res_2_2)


    res_1_3 = C.encoder_block(skip_1_2, 4 * n_filters)
    skip_1_3 = C.pool(res_1_3)
    skip_1_3 = C.concat(skip_1_3, inputs_waves3)


    res_2_3 = C.encoder_block(skip_2_2, 4 * n_filters)
    skip_2_3 = C.pool(res_2_3)


    res_1_4 = C.encoder_block(skip_1_3, 8 * n_filters)
    skip_1_4 = C.pool(res_1_4)
    skip_1_4 = C.concat(skip_1_4, inputs_waves4)


    res_2_4 = C.encoder_block(skip_2_3, 8 * n_filters)
    skip_2_4 = C.pool(res_2_4)


    res_1_5 = C.encoder_block(skip_1_4, 8 * n_filters)
    skip_1_5 = C.pool(res_1_5)
    # skip_1_4 = C.concat(skip_1_4, inputs_waves4)

    res_2_5 = C.encoder_block(skip_2_4, 8 * n_filters)
    skip_2_5 = C.pool(res_2_5)

    bridge_merge = add(skip_1_5, skip_2_5)
    bridge = C.encoder_block(bridge_merge, 16 * n_filters)

    # Reference Architecture

    up_4 = C.upBlock(bridge, 8 * n_filters)
    merge_4 = C.concat_v2([up_4, skip_1_4, skip_2_4])
    dec_4 = C.encoder_block(merge_4, 8 * n_filters)


    up_3 = C.upBlock(dec_4, 4 * n_filters)
    merge_3 = C.concat_v2([up_3, skip_1_3, skip_2_3])
    dec_3 = C.encoder_block(merge_3, 4 * n_filters)

    up_2 = C.encoder_block(dec_3, 2 * n_filters)
    merge_2 = C.concat_v2([up_2, skip_1_2, skip_2_2])
    dec_2 = C.encoder_block(merge_2, 2 * n_filters)

    up_1 = C.upBlock(dec_2, n_filters)
    merge_1 = C.concat_v2([up_1, skip_1_1, skip_2_1])
    dec_1 = C.encoder_block(merge_1, n_filters)
    # dec_1 = add(res_1_1, res_2_1, dec_1)

    up_final = C.upBlock(dec_1, n_filters)
